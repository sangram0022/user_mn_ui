...
1. [ ] Total tests executed: _____ / 50+
2. [ ] Tests passed: _____ (____%)
3. [ ] Tests failed: _____ (____%)
4. [ ] Critical issues: _____ (should be 0)
5. [ ] Major issues: _____ 
6. [ ] Minor issues: _____
