...
const LazyRoleBasedDashboard = lazy(() => import('../domains/dashboard/pages/RoleBasedDashboardPage'));
const LazyUserManagementEnhanced = lazy(() => import('../domains/users/pages/UserManagementPage'));
const LazyAnalytics = lazy(() => import('../domains/analytics/pages/AnalyticsPage'));
const LazyWorkflowManagement = lazy(() => import('../domains/workflows/pages/WorkflowManagementPage'));
const LazyProfilePage = lazy(() => import('../domains/profile/pages/ProfilePage'));
const LazySettingsPage = lazy(() => import('../domains/settings/pages/SettingsPage'));
const LazyHelpPage = lazy(() => import('../domains/support/pages/HelpPage'));
const LazyReportsPage = lazy(() => import('../domains/reports/pages/ReportsPage'));
const LazySecurityPage = lazy(() => import('../domains/security/pages/SecurityPage'));
const LazyModerationPage = lazy(() => import('../domains/moderation/pages/ModerationPage'));
const LazyApprovalsPage = lazy(() => import('../domains/workflows/pages/ApprovalsPage'));
const LazyActivityPage = lazy(() => import('../domains/activity/pages/ActivityPage'));
const LazyAccountPage = lazy(() => import('../domains/account/pages/AccountPage'));
const LazySystemStatus = lazy(() => import('../domains/status/pages/SystemStatusPage'));
const LazyMyWorkflowsPage = lazy(() => import('../domains/workflows/pages/MyWorkflowsPage'));
