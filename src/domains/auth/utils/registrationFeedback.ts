...
export function buildRegistrationFeedback(response: RegisterResponse): RegistrationFeedback {
  ...
  return { title, subtitle, message, email, redirectSeconds, highlights, nextSteps };
}
