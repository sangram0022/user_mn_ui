  ...
  const getStatusConfig = (status: string, type: string) => {
    if (type === 'reset') {
      ...
      switch (status) {
        ...
        case 'good':
          return { color: 'bg-blue-100 text-blue-800 border-blue-200', icon: Shield };
        case 'fair':
      ...
      return status === 'locked'
        ? { color: 'bg-red-100 text-red-800 border-red-200', icon: Lock }
        : { color: 'bg-green-100 text-green-800 border-green-200', icon: Unlock };
    } else {
      switch (status) {
        case 'critical':
          return { color: 'bg-red-100 text-red-800 border-red-200', icon: XCircle };
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-2xl max-h-[80vh] overflow-hidden">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">Edit Password Policy</h3>
        </div>
  ...
  return (
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
      <div className="bg-white rounded-lg shadow-xl w-full max-w-md">
        <div className="px-6 py-4 border-b border-gray-200">
          <h3 className="text-lg font-medium text-gray-900">Bulk Password Reset</h3>
        </div>
          ...
          <div className="p-6">
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          ...
                          <div className="flex justify-between">
                            ...
                            <span
                              className={
                                passwordPolicy.require_numbers ? 'text-green-600' : 'text-gray-400'
                              }
                            >
                      ...
                      <div>
                        ...
                        <div className="space-y-2 text-sm">
                          <div className="flex justify-between">
                            ...
                            <span className="font-medium">{passwordPolicy.max_age_days} days</span>
                          </div>
                          <div className="flex justify-between">
            ...
            {activeTab === 'resets' && (
              <div className="text-center py-8">
                ...
                <h3 className="text-lg font-medium text-gray-900 mb-2">Password Reset Requests</h3>
            ...
            {activeTab === 'security' && (
              <div className="text-center py-8">
                ...
                <p className="text-gray-600">Security event monitoring interface would go here.</p>
              </div>
            )}
          </div>
        </div>
