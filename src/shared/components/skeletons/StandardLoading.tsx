  ...
  return (
    <div className="relative">
      ...
      <div 
        ...
        aria-live="polite"
      >
        {/* StandardLoading without role to avoid nested status roles */}
        <div className={`flex items-center justify-center`}>
          <svg
            className={`animate-spin text-gray-400 dark:text-gray-500 mr-2 ${size === 'sm' ? 'h-4 w-4' : size === 'md' ? 'h-6 w-6' : 'h-8 w-8'}`}
            xmlns="http://www.w3.org/2000/svg"
            fill="none"
            viewBox="0 0 24 24"
            aria-hidden="true"
