export default function Footer() {
  ...
  return (
    <footer 
      id="footer"
      className="bg-linear-to-r from-gray-900 to-blue-900 text-white mt-auto"
      role="contentinfo"
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-2 mb-4">
              <div 
                className="w-8 h-8 bg-linear-to-br from-blue-400 to-purple-400 rounded-lg flex items-center justify-center"
                aria-hidden="true"
              >
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            <span aria-label={`Copyright ${currentYear} UserMN`}>
              © {currentYear} UserMN. All rights reserved.
            </span>
          </p>
