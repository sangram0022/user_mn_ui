...
export const colors = { // Primary brand colors
  primary: {
    50: '#eff6ff',
    100: '#dbeafe',
    200: '#bfdbfe',
...
// Border radius scale
export const borderRadius = { none: '0px',
  sm: '0.125rem',
  DEFAULT: '0.25rem',
  md: '0.375rem',
  lg: '0.5rem',
...
// Shadows
export const boxShadow = { sm: '0 1px 2px 0 rgb(0 0 0 / 0.05)',
...
export const animation = { none: 'none',
...
export const variants = { button: {
    ...
    secondary: { base: 'bg-white text-secondary-700 border-secondary-300 hover:bg-secondary-50 focus:ring-secondary-500',
      disabled: 'bg-secondary-100 text-secondary-400 cursor-not-allowed'
    },
    success: { base: 'bg-success-500 text-white border-success-500 hover:bg-success-600 focus:ring-success-500',
      disabled: 'bg-success-300 text-success-100 cursor-not-allowed'
    },
    warning: { base: 'bg-warning-500 text-white border-warning-500 hover:bg-warning-600 focus:ring-warning-500',
      disabled: 'bg-warning-300 text-warning-100 cursor-not-allowed'
    },
    error: { base: 'bg-error-500 text-white border-error-500 hover:bg-error-600 focus:ring-error-500',
      disabled: 'bg-error-300 text-error-100 cursor-not-allowed'
    },
    ghost: { base: 'bg-transparent text-secondary-700 border-transparent hover:bg-secondary-100 focus:ring-secondary-500',
      disabled: 'bg-transparent text-secondary-400 cursor-not-allowed'
    },
    outline: { base: 'bg-transparent text-primary-500 border-primary-500 hover:bg-primary-50 focus:ring-primary-500',
  ...
  alert: { success: {
    ...
    warning: { base: 'bg-warning-50 border-warning-200 text-warning-800',
      icon: 'text-warning-400'
    },
    error: { base: 'bg-error-50 border-error-200 text-error-800',
      icon: 'text-error-400'
    },
    info: { base: 'bg-info-50 border-info-200 text-info-800',
      icon: 'text-info-400'
    }
  }
} as const;
...
// Breakpoints
export const breakpoints = { sm: '640px',
  md: '768px',
  lg: '1024px',
  xl: '1280px',
  '2xl': '1536px' } as const;
...
export const baseClasses = { button: 'inline-flex items-center justify-center border font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed',
...
// Layout constants
export const layout = { containerMaxWidth: {
    sm: '640px',
    md: '768px',
    lg: '1024px',
    xl: '1280px',
...
export const designUtils = { // Get color value by path
  ...
  buildClass: (...classes: (string | undefined | null | false)[]): string => { return classes.filter(Boolean).join(' ');
  },
  ...
  mergeVariants: (base: string, variant?: string, size?: string, className?: string): string => { return designUtils.buildClass(base, variant, size, className);
  }
};
