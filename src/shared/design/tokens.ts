...
export const variants = {
  ...
  alert: {
    ...
    error: { base: 'bg-error-50 border-error-200 text-error-800', icon: 'text-error-400' },
    info: { base: 'bg-info-50 border-info-200 text-info-800', icon: 'text-info-400' },
  },
} as const;
...
export const baseClasses = {
  button:
    'inline-flex items-center justify-center border font-medium focus:outline-none focus:ring-2 focus:ring-offset-2 transition-colors duration-200 disabled:opacity-50 disabled:cursor-not-allowed',
  input:
    'block w-full border rounded-md shadow-sm focus:outline-none focus:ring-2 focus:ring-offset-0 transition-colors duration-200 disabled:bg-gray-50 disabled:text-gray-500',
