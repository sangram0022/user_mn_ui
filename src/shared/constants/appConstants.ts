...
// API Configuration
export const API_CONFIG = { BASE_URL: process.env.REACT_APP_API_URL || 'http://localhost:3001/api',
  TIMEOUT: 15000,
  RETRY_ATTEMPTS: 3,
  CACHE_TTL: 5 * 60 * 1000, // 5 minutes } as const;

// Authentication Configuration
export const AUTH_CONFIG = { TOKEN_KEY: 'authToken',
  USER_KEY: 'user',
...
// UI Configuration
export const UI_CONFIG = { SIDEBAR_WIDTH: 280,
...
// Theme Configuration
export const THEME_CONFIG = { DEFAULT_THEME: 'system' as const,
...
export const PERMISSIONS = { // User management
...
export const PERFORMANCE_CONFIG = { DEBOUNCE_DELAY: 300,
  THROTTLE_DELAY: 100,
...
// Feature Flags
export const FEATURE_FLAGS = { ENABLE_ANALYTICS: process.env.REACT_APP_ENABLE_ANALYTICS === 'true',
  ...
  ENABLE_FILE_UPLOADS: process.env.REACT_APP_ENABLE_FILE_UPLOADS === 'true',
...
export const ENV_CONFIG = { IS_DEVELOPMENT: process.env.NODE_ENV === 'development',
...
export const MONITORING_CONFIG = { ERROR_REPORTING_ENDPOINT: process.env.REACT_APP_ERROR_REPORTING_ENDPOINT,
  ...
  SAMPLE_RATE: parseFloat(process.env.REACT_APP_SAMPLE_RATE || '0.1'), } as const;

// WebSocket Configuration
export const WEBSOCKET_CONFIG = { URL: process.env.REACT_APP_WEBSOCKET_URL || 'ws://localhost:3001',
  RECONNECT_INTERVAL: 5000,
  MAX_RECONNECT_ATTEMPTS: 10,
  HEARTBEAT_INTERVAL: 30000, } as const;

// Export all constants as a single object for convenience
export const APP_CONSTANTS = { API_CONFIG,
  AUTH_CONFIG,
  UI_CONFIG,
  THEME_CONFIG,
  PAGINATION_CONFIG,
