...
export const ENV = { NODE_ENV: process.env['NODE_ENV'] || 'development',
...
export const API = { BASE_URL: ENV.API_BASE_URL,
...
export const UI = { // Breakpoints (matching Tailwind CSS)
  BREAKPOINTS: {
    SM: 640,
    MD: 768,
    LG: 1024,
...
export const PAGINATION = { DEFAULT_PAGE: 1,
  DEFAULT_LIMIT: 20,
  MAX_LIMIT: 100,
...
export const STORAGE_KEYS = { // Authentication
...
export const ROLE_PERMISSIONS = { [ROLES.SUPER_ADMIN]: Object.values(PERMISSIONS),
  [ROLES.ADMIN]: [
...
export const FILE_UPLOAD = { MAX_SIZE: 10 * 1024 * 1024, // 10MB
  ...
  EXTENSIONS: { IMAGES: ['.jpg', '.jpeg', '.png', '.gif', '.webp', '.svg'],
...
export const NOTIFICATIONS = { DURATION: {
    SUCCESS: 3000,
    INFO: 4000,
    WARNING: 5000,
...
export const DATE_TIME = { FORMATS: {
    DATE: 'yyyy-MM-dd',
...
export const FEATURES = { DARK_MODE: true,
  NOTIFICATIONS: true,
  ANALYTICS: true,
...
export const ANALYTICS = { ENABLED: isProduction,
...
export const SECURITY = { PASSWORD_REQUIREMENTS: {
    MIN_LENGTH: 8,
  ...
  SESSION: { TIMEOUT: 24 * 60 * 60 * 1000, // 24 hours
...
export const ERROR_CODES = { // Authentication
