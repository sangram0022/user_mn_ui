// Navigation debug tooling has been deprecated in favour of React Router DevTools.
export default function NavigationDebug(): never {
  throw new Error('Navigation debug panel has been removed. Use React Router DevTools instead.');
}
